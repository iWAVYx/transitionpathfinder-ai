        ...
        <div className="mx-auto max-w-7xl px-4 pb-32 pt-28 sm:px-6 sm:pb-40 sm:pt-32 lg:px-8 lg:pb-56 lg:pt-40">
          <div className="max-w-2xl">
            ...
            <HeroCTAs forceRow className="mt-9 gap-1 sm:gap-3">
              ...
              <Link
                to="/demo"
                className="group inline-flex items-center justify-center gap-1 rounded-full border border-primary/30 bg-background/90 px-1.5 py-2 text-[11px] font-semibold text-foreground backdrop-blur transition-all hover:-translate-y-0.5 hover:border-primary/60 hover:bg-background sm:gap-1.5 sm:px-4 sm:py-3 sm:text-xs lg:px-7 lg:py-3.5 lg:text-sm"
              >
              ...
              <Link
                to="/platform"
                className="group inline-flex items-center justify-center gap-1 rounded-full border border-foreground/15 bg-background/80 px-1.5 py-2 text-[11px] font-semibold backdrop-blur transition-all hover:-translate-y-0.5 hover:bg-background sm:gap-1.5 sm:px-4 sm:py-3 sm:text-xs lg:px-7 lg:py-3.5 lg:text-sm"
              >
