...
const features = [
  { icon: Sparkles, title: "AI Pathway Builder", body: "Share strengths, interests, and goals. We generate a personalized Pathway Report — career directions, life skills, family questions, and a 30-day plan." },
  { icon: Mic, title: "Student Voice Profile", body: "A student-owned space: strengths, interests, the kind of life they want after high school, and what they want their PPT team to know." },
  ...
  { icon: Target, title: "Goal & Progress Tracker", body: "A visual chain: Goal → Skill → Evidence → Progress → Next Step. Progress finally lines up with the plan." },
  ...
  { icon: MapPin, title: "Resource & Opportunity Match", body: "Connecticut-aware matches: community colleges, technical high schools, BRS, job training, internships — tuned to interest, location, and grade." },
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 pt-16 pb-12 sm:px-6 md:grid-cols-[1.05fr_1fr] lg:px-8 lg:pt-24 lg:pb-16">
          ...
          <div className="relative">
            ...
            <img
              src={platformHero}
              alt="A warm desk with a notebook, laptop, and planning documents"
              width={1600}
              height={1200}
