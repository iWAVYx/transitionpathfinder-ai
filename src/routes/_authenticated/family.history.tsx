...
type FilterKey = "all" | "documents" | "sharing" | "meetings" | "plan";
...
function classifyEntry(entry: AuditEntry): FilterKey {
      ...
      >
        ...
        <header className="mt-4 mb-6">
          ...
          <p className="mt-2 text-muted-foreground">
            Every time someone views, downloads, edits, or shares your student's
            plan or documents, it's recorded here. You can review the full
            record and act on anything that looks off.
          </p>
        </header>
                ...
                <TabsContent key={f.key} value={f.key} className="mt-4">
                  {loading ? (
                    ...
                    <EmptyState
                      ...
                      body={
                        activeStudent
                          ? `No ${f.key === "all" ? "" : f.label.toLowerCase() + " "}activity recorded yet for ${activeStudent.first_name}.`
                          : "No activity recorded yet."
                      }
                      cta={{ label: "Review sharing & consent", to: "/family/consent" }}
                    />
                  ) : (
