...
export const Route = createFileRoute("/privacy")({
  ...
  component: () => (
    <ComingSoon
      ...
      body="Everything you upload — your child's IEP, the Connecticut SED forms, any notes you keep alongside them — is encrypted, locked to your account alone, and never used to train any AI model. You can delete a single document, or your entire account, whenever you choose. We'll publish the full consent flow, our retention windows, and our FERPA stance in plain language alongside the IEP upload feature in the next build. If you have a question between now and then, ask — we'd rather answer it directly."
    />
  ),
});
