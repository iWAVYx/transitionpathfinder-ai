...
export const runSystemHealth = createServerFn({ method: "GET" })
  ...
  .handler(async ({ context }) => {
    ...
    const probes: Array<{
      ...
      { key: "waitlist", label: "Waitlist", table: "waitlist_entries", category: "ops" },
      { key: "contact_forms", label: "Contact Forms", table: "contact_submissions", category: "ops" },
      { key: "partner_submissions", label: "Partner Submissions", table: "partner_applications", category: "ops" },
