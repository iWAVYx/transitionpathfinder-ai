...
const h1 = { fontSize: "22px", fontWeight: 700, color: "#242A33", margin: "0 0 8px" };
...
const statNum = { fontSize: "20px", color: "#242A33" };
...
const channelTitle = { fontSize: "15px", fontWeight: 600, color: "#242A33", margin: "0 0 4px" };
...
const cta = { fontSize: "13px", color: "#5B2A86", textDecoration: "none" };
...
const footerLink = { color: "#5B2A86", textDecoration: "none" };
