...
/**
 * Shared drawer for the School Admin dashboard. Mirrors the Parent /
...
/** Empty-state CTA text nudges the school leader toward the exact next step. */
function emptyCta(id: SchoolAdminFeatureId): string {
  switch (id) {
    case "team-access":
      return "Invite Staff";
