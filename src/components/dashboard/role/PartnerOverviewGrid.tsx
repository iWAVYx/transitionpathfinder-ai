    ...
    >
      <ToolPreviewGrid>
        <ToolPreviewCard
          ...
          cta={{ label: "Edit profile", to: "/partners-manage" }}
        />
        <ToolPreviewCard
          icon={Sparkles}
          ...
          cta={{ label: "Manage opportunities", to: "/opportunities" }}
        />
        <ToolPreviewCard
          icon={ClipboardList}
          ...
          cta={{ label: "See submissions", to: "/partners-manage" }}
        />
        <ToolPreviewCard
          icon={CalendarClock}
          ...
          status="This month"
          tone="default"
          summary="Application windows, cohort starts, and program deadlines."
          cta={{ label: "Open calendar", to: "/opportunities" }}
        />
        <ToolPreviewCard
          icon={Settings2}
          ...
          cta={{ label: "Open management", to: "/opportunities" }}
        />
        <ToolPreviewCard
          icon={Award}
