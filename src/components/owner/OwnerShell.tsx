...
const NAV: NavItem[] = [
  ...
  { to: "/owner/testing", label: "Testing Runs", icon: ClipboardCheck, group: "Validation" },
  { to: "/owner/testing-scripts", label: "Testing Scripts", icon: ClipboardCheck, group: "Validation" },
    ...
    <div className="min-h-dvh bg-muted/30 text-foreground">
      <div className="flex min-h-dvh">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          <main className="flex-1 overflow-x-hidden px-4 py-5 sm:px-6 sm:py-6 lg:py-8">{children}</main>
        </div>
      </div>
    </div>
  );
