...
| Malware scanning on upload    | Cloudmersive selected; adapter review, privacy approval, staging key, and live proof pending | C (required) | Engineering + Founder + Vendor |
