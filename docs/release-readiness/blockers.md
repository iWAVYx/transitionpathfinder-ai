...
| ---- | ------------------------------------------------------------------ | ----- | --- | ---------------------------- | ------------------------------------------------------------------------------------------------------------ |
| B-01 | Malware / AV scanning on document and Channel uploads              | C     | P0  | Engineering + Founder + Vendor | The protected synthetic `channel-attachments` clean/EICAR proof is complete at exact staging SHA `193bed60f8d3d4233aab7cc043709e52cb388790` (run `35521640583`). Closing this blocker still requires an effective Cloudmersive DPA and accepted education-data/privacy, region, subprocessor, retention, file-size, rate-limit, support, and availability terms; equivalent protected synthetic proof for `student-documents`; and separately authorized production configuration and migrations. |
