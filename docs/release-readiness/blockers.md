...
| ---- | ------------------------------------------------------------------ | ----- | --- | ---------------------------- | ------------------------------------------------------------------------------------------------------------ |
| B-01 | Malware / AV scanning on document and Channel uploads              | C     | P0  | Engineering + Founder + Vendor | Cloudmersive staging key and approved plan/region are configured only after DPA/subprocessor review; one clean file and the harmless EICAR test file prove fail-closed scanning, infected-object deletion, and clean-only download across both `student-documents` and `channel-attachments`; production configuration is separately approved and recorded. |
