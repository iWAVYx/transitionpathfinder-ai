...
| ---------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Student, Family, Educator dashboards           | Live preview-first alignment implemented                                                   | Reconfirm the complete save-and-refresh loop in isolated staging.                                                                                                                              |
| School and District dashboards                 | Live aggregate alignment merged and deployed at `7570409232d567833574c157b4570275f964984f` | Preserve school/district scoping and finish exact-SHA acceptance.                                                                                                                              |
| Partner dashboard                              | In progress on this branch                                                                 | Real organization/profile/opportunity data, no demo totals, no student records, real Preview and Open Full Tool actions.                                                                       |
| Owner Hub                                      | In progress on this branch                                                                 | `/owner` remains the one private owner dashboard; live aggregate previews open protected full tools.                                                                                           |
